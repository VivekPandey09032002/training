...
class ReviewRepositoryTests {
    ...
    void ReviewRepository_SaveAll_ReturnsSavedReview() {
        ...
        Assertions.assertThat(savedReview.getId()).isPositive();
    }

    @Test
    void ReviewRepository_GetAll_ReturnsMoreThenOneReview() {
        Review review = Review.builder().title("title").content("content").stars(5).build();
        ...
        Assertions.assertThat(reviewList).isNotNull().hasSize(2);
    }
    ...
    void ReviewRepository_FindById_ReturnsSavedReview() {
        ...
        Assertions.assertThat(reviewReturn).isPresent().isNotNull();
    }
    ...
    void ReviewRepository_UpdateReview_ReturnReview() {
        ...
        Optional<Review> reviewSaveOptional = reviewRepository.findById(review.getId());
        Assertions.assertThat(reviewSaveOptional).isPresent();
        Review reviewSave = reviewSaveOptional.get();
